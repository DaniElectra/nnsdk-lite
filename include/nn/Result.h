...
// Imported from https://github.com/3dsdecomp/nnsdk/blob/main/Include/nn/Result.h
...
// Helper macro for transforming a raw value into an nn::Result
#define RAW_RESULT(res) (*reinterpret_cast<nn::Result *>(&res))
